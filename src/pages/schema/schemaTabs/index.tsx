...
import { SchemaAddReceipt } from "./addReceipt";
import { SelectSchema } from "./selectSchema";
import { SelectDesign } from "./selectSchemaDesign";
...
export function SchemaTabs() {
  ...
  return (
    <MainWrap>
      ...
      <div className="">
        {activeTab === 1 && <SelectSchema />}
        {activeTab === 2 && <SelectDesign />}
        {activeTab === 3 && <SchemaAddReceipt />}
