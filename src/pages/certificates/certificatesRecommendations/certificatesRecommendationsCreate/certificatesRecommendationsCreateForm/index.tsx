...
const certificateRecommendationsCreateSchema = z.union([
  certificateSchema,
  nameUrlSchema,
]);

const defaultRecommendationValues: Partial<CertificateRecommendationsCreateSchema> =
  {
    name: "",
    url: "",
    description: "",
...
type CertificateRecommendationsCreateSchema = z.infer<
  typeof certificateRecommendationsCreateSchema
>;

interface CertificateRecommendationsCreateProps
  extends HTMLAttributes<HTMLDivElement> {}

export function CertificatesRecommendationsCreateForm({
  className,
  ...props
}: CertificateRecommendationsCreateProps) {
  const form = useForm<CertificateRecommendationsCreateSchema>({
    resolver: zodResolver(certificateRecommendationsCreateSchema),
  ...
  async function onSubmit(data: CertificateRecommendationsCreateSchema) {
