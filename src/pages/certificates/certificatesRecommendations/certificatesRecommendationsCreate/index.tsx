...
import { CertificatesRecommendationsCreateForm } from "./certificatesRecommendationsCreateForm";

type CertificatesRecommendationsCreateProps = {
  className?: string;
  variant?: "desktop" | "mobile";
};

export function CertificatesRecommendationsCreate({
  className,
  variant,
}: CertificatesRecommendationsCreateProps) {
  return (
    <Sheet>
      ...
      <SheetContent className="w-full overflow-auto sm:w-auto">
        ...
        <CertificatesRecommendationsCreateForm />
      </SheetContent>
    </Sheet>
  );
}
