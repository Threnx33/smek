...
import { CertificatesCollectionsCreateForm } from "./certificatesCollectionsCreateForm";

export function CertificatesCollectionsCreate() {
  return (
    <Sheet>
      ...
      <SheetContent className="w-full overflow-auto sm:w-auto">
        ...
        <CertificatesCollectionsCreateForm />
      </SheetContent>
    </Sheet>
  );
}
