...
import { z } from "zod";
import CreateCertificateTemplateButtons from "./createCertificatesTemplateButtons";
...
const createCertificateTemplateSchema = z.object({
  certificateName: z.string().min(1, "Certificate name required"),
  description: z.string(),
  earnCertificate: z.enum(["yes", "no"]),
  type: z.string(),
  level: z.string(),
  time: z.string(),
  cost: z.string(),
      ...
      <div className="flex flex-col items-center">
        <div className="flex flex-col xl:w-9/12">
          <div className="flex justify-between">
            ...
            <CreateCertificateTemplateButtons />
          </div>
            ...
            <div className="mb-6 flex flex-col items-start justify-between md:flex-row md:items-center">
              ...
              <div className="md:px-10">
                ...
                <div className="mb-4 text-sm md:mb-6">
                  Certificate tempaltes must use images in png format, with
                  dimensions between 600x600 and 2048x2048 pixels. Or select
                  from the templates you created on designer.
                </div>
            ...
            <Form {...form}>
              <form className="flex flex-col">
                ...
                <CustomTextarea
                  ...
                  name="description"
                  label="Description"
                  placeholder="Type in certificate description"
                  className="mb-8"
                />
                ...
                <div className="mb-2 text-sm ">
                  ...
                  skillquiver users with the opportunity to earn this
                  certificate.
                </div>
                <CustomRadioGroup
                  className="mb-8"
                ...
                <div className="mb-4 text-sm">
                  Attributes improve your certificate’s overall discoverability,
                  as well as the likelihood it will be recommended to
                  Skillquiver users. Learn more about attributes{" "}
                ...
                <CustomCheckbox
                  ...
                  label="Display attributes on the public view of this certificate"
                />
