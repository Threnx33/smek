...
import { z } from "zod";
import { COLLECTIONS } from "../../certificatesCollections/data";
import { CertificatesTemplatesSettingsCustomSelect } from "./certificatesTemplatesSettingsCustomSelect";
...
const certificatesTemplateSettingsSchema = z.object({
...
const defaultRecommendationValues: Partial<CertificatesTemplateSettingsSchema> =
  {
...
type CertificatesTemplateSettingsSchema = z.infer<
  typeof certificatesTemplateSettingsSchema
>;

export function CertificatesTemplateSettings() {
  const form = useForm<CertificatesTemplateSettingsSchema>({
    resolver: zodResolver(certificatesTemplateSettingsSchema),
  ...
  async function onSubmit(data: CertificatesTemplateSettingsSchema) {}
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          ...
          >
            <div className="flex flex-col">
              <CertificatesTemplatesSettingsCustomSelect
                form={form}
                name="collections"
          ...
          <SettingsSection
            ...
            descriptionText="Set a default expiration for certificates issued from this template."
          >
          ...
          <SettingsSection
            ...
            descriptionText="Send message to your earners who have certificates expiring in 60 days."
          >
            <CustomRadioGroupWithDescription
              form={form}
