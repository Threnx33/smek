...
type CertificatesTemplatesSettingsCustomSelectProps<T extends FieldValues> = {
...
export function CertificatesTemplatesSettingsCustomSelect<
...
>({
  ...
  mandatory,
  className,
}: CertificatesTemplatesSettingsCustomSelectProps<T>) {
  return (
    <FormField
