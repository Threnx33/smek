...
const CERTIFICATES_DETAILS_MORE_BUTTON = [
  { label: "Edit", img: "edit" },
...
const CERTIFICATES_DETAILS_ATTRIBUTES = [
...
const CERTIFICATES_DETAILS_SKILLS = [
  "Communication",
  "Design Thinking",
...
export function CertificatesTemplatesDetails() {
    ...
    <CertificatesTemplateWrap>
      <div className="flex flex-col text-sm">
        <div className="mb-3 ml-auto flex items-center xl:mb-6">
          <CertificatesTemplatesIssueButton
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              {CERTIFICATES_DETAILS_MORE_BUTTON.map((item) => (
        ...
        <div className="flex flex-col items-center xl:flex-row xl:items-start">
          ...
          <div className="flex w-full flex-col">
            {headerText("Certificate Details")}
            ...
            <div className="mb-4">
              The Foundations of Leadership - International certificate is
              issued to students in Latin America who have completed the
              Fundamentos de Liderazgo 96-hour course.
            </div>
            <TextMainWrap className="mb-6">Learn more</TextMainWrap>

            {headerText("Certificate Attributes")}
            <div className="mb-6 space-y-2">
              {CERTIFICATES_DETAILS_ATTRIBUTES.map((item) => (
                <div
                  key={item.label}
            ...
            {headerText("Skills")}
            <div className="mb-6 space-y-2">
              {CERTIFICATES_DETAILS_SKILLS.map((item) => (
                <div
                  key={item}
            ...
            <div className="mb-4">
              ...
              certificate signifies that a foundational level of leadership has
              been achieved. The recipient has demonstrated an understanding of
