...
import { CertificatesTemplatesIssueFormId } from "./certificatesTemplatesIssueFormId";
import { CertificatesTemplatesIssueFormText } from "./certificatesTemplatesIssueFormText";
import { CertificatesTemplatesIssueFormUpload } from "./certificatesTemplatesIssueFormUpload";
import { CertificatesTemplatesIssueFormUrl } from "./certificatesTemplatesIssueFormUrl";

const certificateTemplatesIssueSchema = z.object({
...
const defaultIssueValues: Partial<CertificateTemplatesIssueSchema> = {
...
export type CertificateTemplatesIssueSchema = z.infer<
  typeof certificateTemplatesIssueSchema
>;

type CertificatesTemplatesIssueFormProps = {
  issuer?: string;
  templateName?: string;
};

export function CertificatesTemplatesIssueForm({
  issuer,
  templateName,
}: CertificatesTemplatesIssueFormProps) {
  const form = useForm<CertificateTemplatesIssueSchema>({
    resolver: zodResolver(certificateTemplatesIssueSchema),
  ...
  async function onSubmit(data: CertificateTemplatesIssueSchema) {
    ...
    <div>
      <Form {...form}>
        <form className="flex flex-col" onSubmit={form.handleSubmit(onSubmit)}>
          ...
          {openedCard === "Url" && (
            <CertificatesTemplatesIssueFormUrl
              form={form}
              setOpenedCard={setOpenedCard}
            />
          )}
          {openedCard === "Text" && (
            <CertificatesTemplatesIssueFormText
              form={form}
              setOpenedCard={setOpenedCard}
            />
          )}
          {openedCard === "Upload" && (
            <CertificatesTemplatesIssueFormUpload
              form={form}
              setOpenedCard={setOpenedCard}
            />
          )}
          {openedCard === "Id" && (
            <CertificatesTemplatesIssueFormId
              form={form}
              setOpenedCard={setOpenedCard}
            />
          )}
