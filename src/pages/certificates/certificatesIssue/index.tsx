...
export function CertificatesIssue() {
  return (
    <TitleWithTabsWrap title="Certificates" tabs={CERTIFICATES_MENU_TABS}>
      ...
      <div className="mt-14 flex justify-center text-center text-sm font-normal">
        <div className="w-9/12">
          ...
          import a list of certificate earners to skillquiver. Be sure your CSV
          file is in the <TextMainWrap>required format</TextMainWrap> and all
